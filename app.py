...
def run_analysis(ticker, start_date, end_date, forecast_years, extra_percentiles_str):
    """
    ...
    simulation_paths = analysis.monte_carlo_simulation(last_price, best_dist, best_params, days_to_simulate)
    ...
    report += "Projected Values (End of Horizon):\n"
...
with gr.Blocks(title="Equity Analysis App") as app:
    ...
    with gr.Row():
        ...
        with gr.Column(scale=3):
            output_report = gr.Textbox(label="Analysis Report", lines=10)
    ...
    run_btn.click(
        fn=run_analysis,
        inputs=[ticker_input, start_date_input, end_date_input, years_input, percentiles_input],
